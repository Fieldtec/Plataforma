...
namespace PlataformaWeb.Business.Models.Validations.DomainValidation
{
    ...
    {
        public static bool TemDocumentoValido(string documento)
        {
            if (CpfValidacao.Validar(documento) || CnpjValidacao.Validar(documento))
                return true;
    ...
    public class CnpjValidacao
    {
        ...
        {
            var cnpjNumeros = cpnj.ApenasNumeros();
