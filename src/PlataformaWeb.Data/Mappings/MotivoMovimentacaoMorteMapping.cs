...
{
    public class MotivoMovimentacaoMorteMapping : IEntityTypeConfiguration<MotivoMovimentacao>
    {
        public void Configure(EntityTypeBuilder<MotivoMovimentacao> builder)
        {
            builder.ToTable("auxmotivomovimentacao");
            ...
            builder.HasOne(d => d.Cliente)
                .WithMany(p => p.MotivosMovimentacoes)
